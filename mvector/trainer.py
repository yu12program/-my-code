...
from mvector._init_ import SUPPORT_MODEL, __version__
...
class MVectorTrainer(object):
    ...
    def evaluate(self, resume_model='model/EcapaTdnn_MelSpectrogram/best_model/', save_image_path=None):
        """
        评估模型
    ...
    def export(self, save_model_path='model/', resume_model='model/EcapaTdnn_MelSpectrogram/best_model/'):
        """
        导出预测模型
        :param save_model_path: 模型保存的路径
